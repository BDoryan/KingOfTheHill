...
public class ScoreboardSign_1_8_8 {
	...
	public ScoreboardSign_1_8_8(Player player, String objectiveName) {
		this.player = player;
		this.objectiveName = objectiveName;
	}

	public ScoreboardSign_1_8_8(Player player, String objectiveName, String[] lines) {
		this.player = player;
		this.objectiveName = objectiveName;
		this.lines = lines;
	}
